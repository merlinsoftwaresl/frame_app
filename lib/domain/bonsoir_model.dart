...
abstract class BonsoirActionModel<T, A extends BonsoirActionHandler<E>,
    E extends BonsoirEvent> extends ChangeNotifier {
  ...
  void _changeState(T argument, BonsoirActionState newState,
      {bool notify = true}) {
  ...
  BonsoirActionState getActionState(T argument) =>
      _bonsoirActionsState[argument] ?? BonsoirActionState.notReady;
